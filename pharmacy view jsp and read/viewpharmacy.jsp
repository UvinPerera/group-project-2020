...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/viewpharmacy.css" media="screen" />
</head>
<body>
 ...
 <div class="contentContainer">
  ...
  <div class="profile">
    ...
    <button class="button" id="profilePic" onclick="window.location.href='back'"><b>Back</b></button>
  </div>
  <div class="login">
