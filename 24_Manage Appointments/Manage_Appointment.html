...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/Manage_Appointment.css" media="screen" />
  <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
  <script language="JavaScript" type="text/javascript" src="js/Manage_Appointment.js"></script>
