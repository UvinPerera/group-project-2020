...
<body>
  ...
  <div class="container">
      <div class="profile">
          ...
          <div><center>
            <a href="viewadmin.jsp"class="btn">View Profile</a>
            <br><br><br>
            <a href="editadmin.jsp" class="btn">Edit Profile</a>
              </center>
          </div>
        ...
        <div id="Services" class="tabcontent">
          <div class="serviceTile">
              <center> <button class="styled" type="button" onclick="window.location.href='managePatients.jsp'">Manage Patients</button></center>
          
          </div>
            <div class="serviceTile">
              <center><button class="styled" type="button" onclick="window.location.href='manageDoctors.jsp'">Manage Doctors</button></center>
          
          </div>
           <div class="serviceTile">
              <center> <button class="styled" type="button" onclick="window.location.href='manageHospital.jsp'">Manage Hospitals</button></center>
            ...
            <div class="serviceTile">
              <center><button class="styled" type="button" onclick="window.location.href='manageReviews.jsp'">Manage Reviews</button></center>
