              ...
              <!--######################-->
               ...
               <main>
                    ...
                    <div class="main_container">
                        ...
                        <!--######################-->
                        <div class="buttons">
                            <a href="createpharmacy" class=""><button class="button" ><b>Create a new pharmacy</b></button></a>
                        </div>
                                              ...
                                              <% for(Pharmacy row : table) { %>
                                                  <tr id="id_<%= table.indexOf(row) %>" value="<%= table.indexOf(row) %>">
                                                      ...
                                                      <td><%=row.id%></td>
                                                       ...
                                                       <td><a href ="adminviewpharmacy?pId=<%=row.id%>"><button><i class="fa fa-eye"></i></button></a><a href ="adminupdatepharmacy?pId=<%=row.id%>"><button><i class="fa fa-edit"></i></button></a><a href="admindeletepharmacy?pId=<%=row.id%>"><button><i class="fa fa-trash"></i></button></a></td>
                                                  </tr>
                                                  <script>
