               ...
               <main>
                    ...
                    <div class="main_container">
                       ...
                       <div class="main_greeting">
                         ...
                         <form class="" action="hospitalupdate" method="POST" id="updateForm" enctype="multipart/form-data">
                          ...
                          <div class="main_cards">
                                    ...
                                    <div class="card">
                                        <div class="card_inner_profile">
                                             ...
                                             <input class="data" type="text" name="hospital_name" id="hospitalname" placeholder="Hospital Name" value="<%= row2.name %>" readonly>
                                    ...
                                    <div class="card">
                                        <div class="card_inner_profile">
                                             <p class="text-primary-p">Hospital Display Name</p>
                                             <input class="data" type="text" name="hospital_display_name" id="hospitaldisplayname" placeholder="Hospital Display Name" value="<%= row2.displayName %>">
                                    ...
                                    <div class="card">
                                        <div class="card_inner_profile">
                                             <p class="text-primary-p">Hospital Display Picture</p>
                                             <input class="data" type="file" name="hospital_display_pic_path" id="hospitaldisplaypp" placeholder="Hospital Display Picture Path" value="<%= row2.displayPicLocation %>">
                                     ...
                                     <div class="card">
                                        <div class="card_inner_profile">
                                             <p class="text-primary-p">Hospital Land Number</p>
                                             <input class="data" type="text" name="hospital_land_number" id="hospitallandnumber" placeholder="Hospital Land Number" value="<%= row2.landNumber %>">
                                    ...
                                    <div class="card">
                                        <div class="card_inner_profile">
                                             <p class="text-primary-p">Hospital Fax Number</p>
                                             <input class="data" type="text" name="hospital_fax" id="hospitalfax" placeholder="Hospital Fax Number" value="<%= row2.fax %>">
                                    ...
                                    <div class="card">
                                        <div class="card_inner_profile">
                                             <p class="text-primary-p">Hospital Email Address</p>
                                             <input class="data" type="text" name="hospital_email" id="hospitalemail" placeholder="Hospital Email Address" value="<%= row2.email %>" readonly>
                                    ...
                                    <div class="card">
                                        <div class="card_inner_profile">
                                             <p class="text-primary-p">Hospital Address</p>
                                             <input class="data" type="text" name="hospital_address" id="hospitaladdress" placeholder="Hospital Address" value="<%= row2.address1 %>">
