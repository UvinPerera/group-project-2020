<%-- 
    Document   : ReviewPharmacy
    Created on : Nov 30, 2020, 8:40:33 PM
    Author     : Ifra
--%>
...
<body>
  <div class="navbar" id="navbar">
      ...
      <li><a href="/MediHub">Home</a></li>
        ...
        <div class="search">
        <input class="searchinput" type="text" placeholder="Search Pharmacy">
    ...
    <div class="container">
        ...
        <div class="profile">
          <img src="./public/images/pharmacy1.jpg" id="profile">
  ...
  <div class="information">
   <h3 style="text-align:center;font-size:25px;margin-bottom:40px;">City Pharmacy, Galle</h3>

   <div class="record">
   <div class="label">Pharmacy Name </div>
   <div class="data"> City Pharmacy</div>
 </div>
 ...
 <div class="record">
   ...
   <div class="data">citypharmacy@gmail.com</div>
 </div>
