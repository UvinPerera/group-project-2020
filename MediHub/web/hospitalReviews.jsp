                                             ...
                                             <table id="avail" class="display charts_table" style="width:100%">
                                                  ...
                                                  <% if(table.size()>10 || getLimit>0) { %>
                                                        ...
                                                        <p style="text-align: center;">
                                                            <% if(getLimit>0) { %>
                                                                <a href="BrowseHospitalReviews?search=1&hospital=<%=getHospital%>&limit=<%=getLimit-10%>">Prev</a>
                                                            <% } %>
                                                            &nbsp;
                                                            <% if(table.size()>10) { %>
                                                                <a href="BrowseHospitalReviews?search=1&hospital=<%=getHospital%>&limit=<%=getLimit+10%>">Next</a>
                                                            <% } %>
                                                        </p>
                                                        </div>
                                                        <%}%>
