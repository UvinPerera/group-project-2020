              ...
              <!--######################-->
               ...
               <main>
                    ...
                    <div class="main_container">
                       ...
                       <form class="" action="searchhospital" method="GET" id="submitForm">
                                 ...
                                 <div class="card">
                                      ...
                                      <div class="card_inner_profile">
                                           ...
                                           <p class="text-secondary-p">
                                               ...
                                               <select name='hospital' class="pharmacy_select" style="width: 100%" id="pharmacy">
                                             ...
                                             <tbody>
                                                  ...
                                                  <tr id="id_<%= table.indexOf(row) %>" value="<%= table.indexOf(row) %>">
                                                      ...
                                                      <td><%=row.id%></td>
                                                       ...
                                                       <td><a href ="adminviewhospital?hId=<%=row.id%>"><button><i class="fa fa-eye"></i></button></a><a href ="adminedithospital?hId=<%=row.id%>"><button><i class="fa fa-edit"></i></button></a><a href ="admindeletehospital?hId=<%=row.id%>"><button><i class="fa fa-trash"></i></button></a></td>
                                                  </tr>
                                                  <script>
