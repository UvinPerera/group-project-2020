               ...
               <main>
                    ...
                    <div class="main_container">
                        ...
                        <%if(request.getAttribute("alert")!=null) { %>
                                   ...
                                   <% } %>
                        <form class="" action="BrowseHospitalReviewsAdmin" method="GET" id="">
                                             ...
                                             <table id="avail" class="display charts_table" style="width:100%">
                                                  ...
                                                  <tbody>
                                                       ...
                                                       <tr>
                                                           ...
                                                           <td style='white-space: normal;'><%= row.HospitalName %></td>
                                                           ...
                                                           <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                &nbsp;
                                                                <a class="button" id="" href="hospitalReviewAccept?id=<%=row.id%>&hospital=<%=getHospital%>" onclick="return confirm('Are you sure want to Accept?');"><i class="fa fa-user-secret"></i></a>
                                                            </td>
                                                       </tr>
                                                  ...
                                                  <% if(table.size()>10 || getLimit>0) { %>
                                                        ...
                                                        <p style="text-align: center;">
                                                            <% if(getLimit>0) { %>
                                                                <a href="BrowseHospitalReviewsAdmin?search=1&hospital=<%=getHospital%>&limit=<%=getLimit-10%>">Prev</a>
                                                            <% } %>
                                                            &nbsp;
                                                            <% if(table.size()>10) { %>
                                                                <a href="BrowseHospitalReviewsAdmin?search=1&hospital=<%=getHospital%>&limit=<%=getLimit+10%>">Next</a>
                                                            <% } %>
                                                        </p>
                                                        </div>
                                                        <%}%>
