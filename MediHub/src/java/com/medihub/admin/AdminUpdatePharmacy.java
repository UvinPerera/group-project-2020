 ...
 * @author DELL
 */
@WebServlet(name = "AdminUpdatePharmacy", urlPatterns = {"/adminupdatepharmacy"})
public class AdminUpdatePharmacy extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String pharmacyId = request.getParameter("pId");
