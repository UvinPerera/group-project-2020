 ...
 * @author uvinp
 */
@WebServlet(name = "PasswordChange", urlPatterns = {"/passchange"})
public class PasswordChange extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
            ...
            String query1="UPDATE password_reset SET ack=1 WHERE email='"+email+"'";
            PreparedStatement stm1 = con.prepareStatement(query1);
            int rs1 = stm1.executeUpdate();
            
            response.sendRedirect("pwdsuccessfullyupdate.jsp");
            }
            catch(Exception e){
