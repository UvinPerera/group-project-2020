 ...
 * @author tharshan
 */
@WebServlet(name = "BrowseDoctor", urlPatterns = {"/BrowseDoctor"})
public class BrowseDoctor extends HttpServlet {
...
//                            out.print("jhfvgj");
                        request.getRequestDispatcher("browseDoctor.jsp").forward(request, response);
                    }
                    catch(Exception e)
                    {
