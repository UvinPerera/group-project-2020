 ...
 * @author tharshan
 */
@WebServlet(name = "BrowseDoctorReviewsGuest", urlPatterns = {"/BrowseDoctorReviewsGuest"})
public class BrowseDoctorReviewsGuest extends HttpServlet {
...
//                                    System.out.println(dr.getDoctorReviews(getDoctor, getLimit));
...
//                            out.print("jhfvgj");
                        request.getRequestDispatcher("doctorReviewsGuest.jsp").forward(request, response);
                    }
                    catch(Exception e)
                    {
