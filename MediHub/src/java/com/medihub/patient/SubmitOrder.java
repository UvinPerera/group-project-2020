 ...
 @Override
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try
        {
            ...
            String query2="INSERT INTO order_items (id,order_id,file_path,description,status,created_at,updated_at,created_by) VALUES(NULL,LAST_INSERT_ID(),'"+filepath+"','"+description+"',1,CURRENT_TIMESTAMP,CURRENT_TIMESTAMP,'"+patientId+"')";
