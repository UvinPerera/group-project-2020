 ...
 * @author tharshan
 */
@WebServlet(name = "PatientChannellingRecords", urlPatterns = {"/channellingRecords"})
public class PatientChannellingRecords extends HttpServlet {
...
//                                out.print(request.getParameter("search"));
                                ...
                                String getStartDate=request.getParameter("start_date");
                                String getEndDate=request.getParameter("end_date");
                                String getLimit="0";
...
//                                out.print(p.getChannellingRecords(getStatus, getDoctor, getHospital, getSpecialisation, getStartDate, getEndDate, getLimit));
                                request.setAttribute("records", p.getChannellingRecords(getStatus, getDoctor, getHospital, getSpecialisation, getStartDate, getEndDate, getLimit));
                            }
                        }
                        ...
                        request.getRequestDispatcher("channellingRecords.jsp").forward(request, response);
                    }
                    catch(Exception e)
                    {
