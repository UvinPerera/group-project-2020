 ...
 * @author tharshan
 */
@WebServlet(name = "SubmitReviewP", urlPatterns = {"/submitReviewP"})
public class SubmitReviewP extends HttpServlet {
...
//                        out.print(dr.insertReview(patientId,getPharmacy,getRating,description));
                        int dd=dr.insertReview(patientId,getPharmacy,getRating,description);
                        if(dd>0){
