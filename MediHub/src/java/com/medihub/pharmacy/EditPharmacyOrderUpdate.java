...
public class EditPharmacyOrderUpdate extends HttpServlet {
    ...
    @Override
            ...
            try{
                ...
                ResultSet rs =stmt.executeQuery("SELECT oi.order_id, po.created_by, u.display_name,oi.po.created_at,oi.description , oi.file_path, po.order_status,po.expected_delivery_date FROM pharmacy_orders po JOIN order_items oi ON po.id= oi.order_id JOIN users u ON po.created_by=u.id WHERE po.status=1 and po.id="+orderId);
