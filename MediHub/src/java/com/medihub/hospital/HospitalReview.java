...
//    public String approvedAt;
    ...
    public List<HospitalReview> getHospitalReviews(int dId, String climit) {
        
        String q_order = " ORDER BY created_at DESC";
        String q_limit = " limit "+climit+",11";
        
        String query="SELECT dr.id, dr.patient_id, dr.rating, dr.description, dr.status, dr.created_at, u.first_name, u.last_name, u.profile_pic_path FROM hospital_reviews dr "
                + "JOIN users u ON u.id=dr.patient_id "
                + "WHERE u.status=1 AND dr.status=1 AND dr.hospital_id="+dId + q_order + q_limit;
        ...
        try
        {
            ...
            List<HospitalReview> ddr = new ArrayList<HospitalReview>();
            int[] star=new int[3];
            double f,rating=0;
            int c=5;
    ...
    public List<HospitalReview> getHospitalReportedReviews(int dId, String climit) {
        ...
        try
        {
            ...
            while(rs.next()) { 
                ...
                dr.description = rs.getString("description");
                dr.createdAt = rs.getString("created_at");
                dr.HospitalName = rs.getString("display_name");
                dr.PatientFirstName = rs.getString("first_name");
                dr.PatientLastName = rs.getString("last_name");
                dr.PatienProfilePicPath = rs.getString("profile_pic_path");
    ...
    public int[] getHospitalRating(int dId) {
        
        String query="SELECT AVG(rating) as ratingg FROM hospital_reviews dr "
                + "JOIN users u ON u.id=dr.patient_id "
                + "WHERE u.status=1 AND dr.status=1 AND dr.hospital_id="+dId;
...
//            rating=3.4;
    ...
    public int insertReview(int pId, int hId, int crating, String cdescription) {
        ...
        String query="INSERT INTO hospital_reviews (patient_id, hospital_id, rating, description, status, created_at, updated_at, created_by, updated_by) "
    ...
    public int deleteReview(int id) {
        ...
        String query="UPDATE hospital_reviews SET status=0 WHERE id="+id;
    ...
    public int reportReview(int id) {
        ...
        String query="UPDATE hospital_reviews SET status=5 WHERE id="+id;
    ...
    public int apporoveReview(int id) {
        
        String query="UPDATE hospital_reviews SET status=1 WHERE id="+id;
    ...
    public int updateReview(int id, int pId, int crating, String cdescription) {
        ...
        String query="UPDATE hospital_reviews SET rating="+crating+", description='"+cdescription+"', updated_at=CURRENT_TIMESTAMP, updated_by="+pId+" WHERE id="+id;
