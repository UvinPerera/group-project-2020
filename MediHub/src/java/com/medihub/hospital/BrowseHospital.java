 ...
 * @author tharshan
 */
@WebServlet(name = "BrowseHospital", urlPatterns = {"/BrowseHospital"})
public class BrowseHospital extends HttpServlet {
...
//                                    out.print(h.getHospital(getHospital));
...
//                            out.print("jhfvgj");
                        ...
                        request.getRequestDispatcher("browseHospital.jsp").forward(request, response);
                    }
                    catch(Exception e)
                    {
